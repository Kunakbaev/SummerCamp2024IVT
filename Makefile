...
$(BUILD_DIR)/quadraticEquation.o: quadraticEquationLib/quadraticEquation.cpp
	$(CC) -c $^ $(CFLAGS) -o $@
...
$(BUILD_DIR)/testsGenerator.o: testsGeneratorLib/testsGenerator.cpp
	$(CC) -c $^ $(CFLAGS) -o $@

$(BUILD_DIR)/test_main.o: main.cpp
