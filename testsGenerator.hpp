...
struct Tester {
    /**
        \brief all tests
        \warning there are 2 solutions, they should be place in assending order
    */
    const struct Test tests[9] = {
        {{1.0, 1.0, -12.0, 10}, {-4, 3, TWO_ROOTS}},
        {{1, -1, (long double)0.25, 10}, {(long double)0.5, 0, ONE_ROOT}},
        {{0, -3, 1, 10}, {(long double)1 / (long double)3, 0, ONE_ROOT}},
